...
public class Forwarding extends ForwardingBase implements IFloodlightModule, IOFSwitchListener, ILinkDiscoveryListener, IRoutingDecisionChangedListener {
    ...
    protected static final int serverPort = 2000;
    protected static Map<Match,Long> blackList = new HashMap<>();
...
//            for(Entry<Match,Long> entry : blackList.entrySet()) {
...
//        } catch (Exception e) {
//            log.info("[!] CANNOT START SOCKET SERVER");
//        }
